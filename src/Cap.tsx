...
function Cap() {
  ...
  const [date, setDate] = useState(init)
    ...
    "mimir//MAXIMUMLIQUIDITYRUNE": 5000000000000,
...
let cap = data['mimir//MAXIMUMLIQUIDITYRUNE']/ (10 ** 8);
  return (
    <div className="App">
       ...
       {cap  > 500000? <h1> Caps may have been raised! Check here <a href='https://twitter.com/THORChain'>THORChain Twitter</a> <br></br>New Cap: {cap}</h1> : <div><h1>Max Rune: {cap}</h1> <p>Do not attempt to add liquidity.</p></div>}
